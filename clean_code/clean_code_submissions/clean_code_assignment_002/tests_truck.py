...
def test_creating_multiple_truck_instances_with_valid_details():
    ...
    # Act
    truck_1 = Truck(
                    max_cargo_weight=max_cargo_weight_1,
                    color=color_1,
    ...
    truck_2 = Truck(
                    max_cargo_weight=max_cargo_weight_2,
                    color=color_2,
...
# Task-5
@pytest.mark.parametrize(
    "special_case_value, return_value", [
        (-1, 0),
        (0, 0),
        (1, 1),
        (2, 2),
...
@pytest.mark.parametrize(
    'max_speed, acceleration, tyre_friction, max_cargo_weight, cargo_weight, current_speed',[
        (10, 1, 1, 10, 1, 1),
        (1, 10, 1, 10, 3, 1),
        (1, 5, 1, 13, 5, 1)
        ])
